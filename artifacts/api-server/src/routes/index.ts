...
const smsConsoleRouter: IRouter = Router();

smsConsoleRouter.get("/sms-console", async (req, res): Promise<void> => {
...
smsConsoleRouter.post("/sms-console/send", async (req, res): Promise<void> => {
